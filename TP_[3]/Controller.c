...
int menu()
{
	...
	validarInt("Ingrese una opcion: ", "Error. Ingrese una opcion valida: ", &opcion, 1, 10);
	...
	if (path != NULL && pArrayListPassenger != NULL)
	{
		...
		else
		{
			...
			if (ll_len(pArrayListPassenger) == 0)
			{
				...
				printf("pasajeros añadidos con exito\n");
...
int controller_addPassenger(LinkedList *pArrayListPassenger)
{
	...
	if (pArrayListPassenger != NULL)
	{
		...
		validarTexto("Ingrese el tipo de pasajero FirstClass o ExecutiveClass o EconomicClass: ", "Error. ReIngrese el tipo de pasajero FirstClass o ExecutiveClass o EconomicClass: ", tipoPasajero, 50);
		...
		{
			validarTexto("Error ReIngrese el tipo de pasajero FirstClass o ExecutiveClass o EconomicClass: ", "Error. ReIngrese el tipo de pasajero FirstClass o ExecutiveClass o EconomicClass: ", tipoPasajero, 50);
			ordenarStrings(tipoPasajero);
		}
